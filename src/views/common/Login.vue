...
const login = () => {
    loginUser({ username: form.name, password: form.password }).then( (res)=>{
      const result = res.data.data;
      const user: UserType = { name: result.username, token: result.token };
      userStore.updateUserInfo(user); // 更新用户信息到 Pinia store
